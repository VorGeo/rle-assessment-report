...
ecosystem_name = '{{ params.ecosystem_name | default("ECOSYSTEM_NAME_PLACEHOLDER")}}'
country_name = '{{ params.country_name | default("COUNTRY_NAME_PLACEHOLDER")}}'
# ecosystem_names_local = {% if params.ecosystem_names_local is defined -%}
#   {{ params.ecosystem_names_local }}
# {% else -%}
#   [{'name': 'PLACEHOLDER', 'reference': '@placeholder_reference'}]
# {% endif %}
ecosystem_names_local = {{ params.ecosystem_names_local | default([{'name': 'PLACEHOLDER', 'reference': '@placeholder_reference'}])}}
biome = '{{ params.biome | default("BIOME_PLACEHOLDER")}}'
functional_group = '{{ params.functional_group | default("FUNCTIONAL_GROUP_PLACEHOLDER")}}'
...
[Biome:]{.parameter} `{python} biome`

[Functional Group:]{.parameter} `{python} functional_group`

[Global classification:]{.parameter} `{python} global_classification`

[IUCN Status:]{.parameter} **`{python} iucn_status`**
