...
ecosystem_names = [{'name': 'Tropical rainforest', 'reference': 'Kress et al., 2003'}, {'name': 'Lowland evergreen rainforest', 'reference': 'Connette et al., 2016'}, {'name': 'Forest on Limestone', 'reference': 'Whitten et al., 1997'}]
```
...
[Authors:]{.parameter} N.J. Murray, R. Tizard, D.A. Keith
...
This is an assessment report for Tanintharyi limestone tropical evergreen forest.
