...
[Ecosystem names:]{.parameter}&nbsp;Tropical rainforest [@kress2003checklist], Lowland evergreen rainforest [@connette2016mapping]
...
![Photo of the ecosystem Tanintharyi island rainforest](MMR-T1.1.1_photo.png){width=400px fig-align="center"}   

<!-- Ecosystem Map -->
[Ecosystem Map:]{.parameter}&nbsp;
![Map of the ecosystem Tanintharyi island rainforest](MMR-T1.1.1_map.png){width=400px fig-align="center"}     

<!-- Description -->
[Description:]{.parameter}&nbsp;Tanintharyi island rainforest occurs on offshore islands across Tanintharyi,
