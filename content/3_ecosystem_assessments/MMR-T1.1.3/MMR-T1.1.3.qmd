...
ecosystem_image = {
    'asset_id': 'projects/goog-rle-assessments/assets/myanmar/mm_ecosys_v7b',
    'pixel_value': '53'
}
```
...
[Ecosystem names:]{.parameter}&nbsp;Tropical rainforest [@kress2003checklist], Lowland evergreen rainforest [@connette2016mapping], Forest on Limestone [Whitten et al., 1997]

<!-- Biome -->
[Biome:]{.parameter}&nbsp;
[Tropical-subtropical forests biome (T1)](../../7_glossary.md)

<!-- Functional Group -->
[Functional Group:]{.parameter}&nbsp;
[Tropical/Subtropical lowland rainforests (T1.1)](../../7_glossary.md)
...
![Map of the ecosystem Tanintharyi limestone tropical evergreen forest](MMR-T1.1.3_map.png){width=400px fig-align="center"}     
